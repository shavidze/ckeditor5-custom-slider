...
//     onLoad: function() {
//       // v4
//       if (CKEDITOR.addCss) CKEDITOR.addCss(this.getSlideShowDialogCss());
//     },
...
//       editor.addCommand(
//         "slideshow",
//         new CKEDITOR.dialogCommand("slideshowDialog", {
...
//       CKEDITOR.dialog.add(
//         "slideshowDialog",
//         this.path + "dialogs/slideshow.min.js"
//       );

//       // v3
//       if (editor.addCss) editor.addCss(this.getSlideShowDialogCss());
...
//                   var imgSrc = CKEDITOR.getUrl(
//                     "plugins/slideshow/images/placeholder.png"
//                   );
//                   var foundOne = false;
...
//                   fakeStyle = fakeElement.attributes.style =
//                     fakeStyle + ' background-image:url("' + imgSrc + '"); ';
//                   fakeStyle = fakeElement.attributes.style =
//                     fakeStyle + " background-size:contain; ";
//                   fakeStyle = fakeElement.attributes.style =
//                     fakeStyle + " background-repeat:no-repeat; ";
//                   fakeStyle = fakeElement.attributes.style =
//                     fakeStyle + " background-position:center; ";
//                   fakeStyle = fakeElement.attributes.style =
//                     fakeStyle + " width:64px; ";
//                   fakeStyle = fakeElement.attributes.style =
//                     fakeStyle + " height:64px; ";
//                   fakeStyle = fakeElement.attributes.style =
//                     fakeStyle + " display:block; ";
//                   fakeStyle = fakeElement.attributes.style =
//                     fakeStyle + " border:1px solid black; ";
